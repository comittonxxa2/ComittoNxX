...
public class ListScreenView extends SurfaceView implements SurfaceHolder.Callback, DrawNoticeListener, ListSwitcherListener, Runnable {
	...
	public void setDrawColor(int clr_dir, int clr_img, int clr_bef, int clr_now, int clr_aft, int clr_bak, int clr_cur, int clr_mrk, int clr_frm, int clr_txt, int clr_inf, int clr_rrb, int clr_bsf, int clr_bse, int clr_fif, int clr_fib) {
		mFileListArea.setDrawColor(clr_dir, clr_img, clr_bef, clr_now, clr_aft, clr_bak, clr_cur, clr_mrk, clr_frm, clr_inf, clr_rrb, clr_bsf, clr_bse);
