...
public class ListScreenView extends SurfaceView implements SurfaceHolder.Callback, DrawNoticeListener, ListSwitcherListener, Runnable {
	...
	public void setDrawColor(int clr_dir, int clr_img, int clr_bef, int clr_now, int clr_aft, int clr_bak, int clr_cur, int clr_mrk, int clr_frm, int clr_txt, int clr_inf, int clr_rrb, int clr_bsf, int clr_bse) {
