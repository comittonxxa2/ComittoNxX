...
public class SetHardwareFileListKeyActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener {
	...
	public static final boolean[] FilelistEnable =
	{
		true,	// 0
		true,
		true,
	...
	{
		R.string.hardwarekey00,		// システム設定
		R.string.hardwarekey01,		// 無反応
		R.string.hardwarekey02,		// 戻る
		R.string.hardwarekey03,		// 決定
		R.string.hardwarekey04,		// 左移動
		R.string.hardwarekey05,		// 右移動
		R.string.hardwarekey06,		// 上移動
		R.string.hardwarekey07,		// 下移動
		R.string.hardwarekey08,		// 先頭へ移動
		R.string.hardwarekey09,		// 末尾へ移動
		R.string.hardwarekey10,		// 親ディレクトリへ移動
		R.string.hardwarekey11,		// リスト選択
		R.string.hardwarekey12,		// リスト上移動
		R.string.hardwarekey13,		// リスト下移動
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for (int i = 0; i < HardwareKeyName.length; i++) {
			if (FilelistEnable[i]) {
				// 有効な項目のみ格納する
				items_temp[loop[0]] = this.getResources().getString(HardwareKeyName[i]);
				loop[0]++;
			}
		}
		// 最大数を合わせなおして格納する
		...
		for (int i = 0; i < DEF.HardwareKeyTitleName.length; i++) {
			...
			// キーを設定
			listPreference.setKey(DEF.HardwareFilelistKeyIdName[i]);
			// タイトルを設定
		...
		mBackKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_BACK);
		mVolumeUpKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_VOLUME_UP);
		mVolumeDownKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_VOLUME_DOWN);
		mCameraKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_CAMERA);
		mFocusKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_FOCUS);
		mMenuKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_MENU);
		mDpadLeftKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_DPAD_LEFT);
		mDpadRightKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_DPAD_RIGHT);
		mDpadUpKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_DPAD_UP);
		mDpadDownKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_DPAD_DOWN);
		...
		mPageDownKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_PAGE_DOWN);
		mEscapeKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_ESCAPE);
		mMoveHomeKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_MOVEHOME);
		mMoveEndKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_MOVEEND);
		mForwardKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_FORWARD);
		mButtonL1Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_BUTTON_L1);
		mButtonL2Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_BUTTON_L2);
		mButtonL3Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_BUTTON_THUMBL);
		mButtonR1Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_BUTTON_R1);
		mButtonR2Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_BUTTON_R2);
		mButtonR3Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_BUTTON_THUMBR);
		mButtonAKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_BUTTON_A);
		mButtonBKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_BUTTON_B);
		mButtonXKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_BUTTON_X);
		mButtonYKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_BUTTON_Y);
		mButtonSelectKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_BUTTON_SELECT);
		mButtonStartKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_BUTTON_START);
		mMediaNextKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_MEDIA_NEXT);
		mMediaPrevKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_MEDIA_PREVIOUS);
		mMediaPlayPauseKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_MEDIA_PLAY_PAUSE);
		mCustom01Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_CUSTOMKEY01);
		mCustom02Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_CUSTOMKEY02);
		mCustom03Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_CUSTOMKEY03);
		mCustom04Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_CUSTOMKEY04);
		mCustom05Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_CUSTOMKEY05);
		mCustom06Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_CUSTOMKEY06);
		mCustom07Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_F_CUSTOMKEY07);
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
		if(key.equals(DEF.KEY_CODE_F_BACK)){
			mBackKey.setSummary(getBackKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_VOLUME_UP)){
			mVolumeUpKey.setSummary(getVolumeUpKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_VOLUME_DOWN)){
			mVolumeDownKey.setSummary(getVolumeDownKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_CAMERA)){
			mCameraKey.setSummary(getCameraKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_FOCUS)){
			mFocusKey.setSummary(getFocusKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_MENU)){
			mMenuKey.setSummary(getMenuKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_DPAD_LEFT)){
			mDpadLeftKey.setSummary(getDpadLeftKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_DPAD_RIGHT)){
			mDpadRightKey.setSummary(getDpadRightKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_DPAD_UP)){
			mDpadUpKey.setSummary(getDpadUpKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_DPAD_DOWN)){
			mDpadDownKey.setSummary(getDpadDownKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_DPAD_CENTER)){
			mDpadCenterKey.setSummary(getDpadCenterKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_ENTER)){
			mEnterKey.setSummary(getEnterKeySummary(sharedPreferences));
		}
		...
		else if(key.equals(DEF.KEY_CODE_F_SEARCH)){
			mSearchKey.setSummary(getSearchKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_PAGE_UP)){
			mPageUpKey.setSummary(getPageUpKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_PAGE_DOWN)){
			mPageDownKey.setSummary(getPageDownKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_ESCAPE)){
			mEscapeKey.setSummary(getEscapeKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_MOVEHOME)){
			mMoveHomeKey.setSummary(getMoveHomeKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_MOVEEND)){
			mMoveEndKey.setSummary(getMoveEndKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_FORWARD)){
			mForwardKey.setSummary(getForwardKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_BUTTON_L1)){
			mButtonL1Key.setSummary(getButtonL1KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_BUTTON_L2)){
			mButtonL2Key.setSummary(getButtonL2KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_BUTTON_THUMBL)){
			mButtonL3Key.setSummary(getButtonL3KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_BUTTON_R1)){
			mButtonR1Key.setSummary(getButtonR1KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_BUTTON_R2)){
			mButtonR2Key.setSummary(getButtonR2KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_BUTTON_THUMBR)){
			mButtonR3Key.setSummary(getButtonR3KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_BUTTON_A)){
			mButtonAKey.setSummary(getButtonAKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_BUTTON_B)){
			mButtonBKey.setSummary(getButtonBKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_BUTTON_X)){
			mButtonXKey.setSummary(getButtonXKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_BUTTON_Y)){
			mButtonYKey.setSummary(getButtonYKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_BUTTON_SELECT)){
			mButtonSelectKey.setSummary(getButtonSelectKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_BUTTON_START)){
			mButtonStartKey.setSummary(getButtonStartKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_MEDIA_NEXT)){
			mMediaNextKey.setSummary(getMediaNextKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_MEDIA_PREVIOUS)){
			mMediaPrevKey.setSummary(getMediaPrevKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_MEDIA_PLAY_PAUSE)){
			mMediaPlayPauseKey.setSummary(getMediaPlayPauseKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_CUSTOMKEY01)){
			mCustom01Key.setSummary(getCustom01KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_CUSTOMKEY02)){
			mCustom02Key.setSummary(getCustom02KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_CUSTOMKEY03)){
			mCustom03Key.setSummary(getCustom03KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_CUSTOMKEY04)){
			mCustom04Key.setSummary(getCustom04KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_CUSTOMKEY05)){
			mCustom05Key.setSummary(getCustom05KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_CUSTOMKEY06)){
			mCustom06Key.setSummary(getCustom06KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_CUSTOMKEY07)){
			mCustom07Key.setSummary(getCustom07KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_CUSTOMKEY08)){
			mCustom08Key.setSummary(getCustom08KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_CUSTOMKEY09)){
			mCustom09Key.setSummary(getCustom09KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_F_CUSTOMKEY10)){
			mCustom10Key.setSummary(getCustom10KeySummary(sharedPreferences));
		}
	}

	public static int getBackKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_BACK, "0"));
	...
	public static int getVolumeUpKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_VOLUME_UP, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getVolumeDownKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_VOLUME_DOWN, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCameraKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_CAMERA, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getFocusKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_FOCUS, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getMenuKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_MENU, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getDpadLeftKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_DPAD_LEFT, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getDpadRightKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_DPAD_RIGHT, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getDpadUpKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_DPAD_UP, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getDpadDownKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_DPAD_DOWN, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getDpadCenterKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_DPAD_CENTER, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getEnterKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_ENTER, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getSpaceKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_SPACE, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getSearchKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_SEARCH, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getPageUpKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_PAGE_UP, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getPageDownKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_PAGE_DOWN, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getEscapeKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_ESCAPE, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getMoveHomeKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_MOVEHOME, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getMoveEndKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_MOVEEND, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getForwardKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_FORWARD, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonL1Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_BUTTON_L1, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonL2Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_BUTTON_L2, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonL3Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_BUTTON_THUMBL, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonR1Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_BUTTON_R1, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonR2Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_BUTTON_R2, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonR3Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_BUTTON_THUMBR, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonAKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_BUTTON_A, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonBKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_BUTTON_B, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonXKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_BUTTON_X, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonYKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_BUTTON_Y, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonSelectKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_BUTTON_SELECT, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonStartKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_BUTTON_START, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getMediaNextKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_MEDIA_NEXT, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getMediaPrevKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_MEDIA_PREVIOUS, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getMediaPlayPauseKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_MEDIA_PLAY_PAUSE, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom01Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_CUSTOMKEY01, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom02Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_CUSTOMKEY02, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom03Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_CUSTOMKEY03, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom04Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_CUSTOMKEY04, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom05Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_CUSTOMKEY05, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom06Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_CUSTOMKEY06, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom07Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_CUSTOMKEY07, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom08Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_CUSTOMKEY08, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom09Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_CUSTOMKEY09, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom10Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_F_CUSTOMKEY10, "0"));
		if (val < 0 || val >= HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	private String getCustom01KeySummary(SharedPreferences sharedPreferences){
		...
		temp += " : " + res.getString(HardwareKeyName[val]);
		return temp;
	}
