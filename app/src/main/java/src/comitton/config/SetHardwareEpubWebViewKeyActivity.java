...
public class SetHardwareEpubWebViewKeyActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		buttoncategory.setTitle(R.string.epubviewerhardwarekeytitle);
		// ボタンが押されたときの処理を設定
		buttoncategory.setOnButtonClickListener(new ButtonPreferenceCategory.OnClickListener() {
			...
			public void onButtonClick() {
				...
				ed.putString(DEF.KEY_CODE_E_BACK, "0");
				ed.putString(DEF.KEY_CODE_E_VOLUME_UP, "0");
				ed.putString(DEF.KEY_CODE_E_VOLUME_DOWN, "0");
				ed.putString(DEF.KEY_CODE_E_CAMERA, "0");
				ed.putString(DEF.KEY_CODE_E_FOCUS, "0");
				ed.putString(DEF.KEY_CODE_E_MENU, "0");
				ed.putString(DEF.KEY_CODE_E_DPAD_LEFT, "0");
				ed.putString(DEF.KEY_CODE_E_DPAD_RIGHT, "0");
				ed.putString(DEF.KEY_CODE_E_DPAD_UP, "0");
				ed.putString(DEF.KEY_CODE_E_DPAD_DOWN, "0");
				ed.putString(DEF.KEY_CODE_E_DPAD_CENTER, "0");
				ed.putString(DEF.KEY_CODE_E_ENTER, "0");
				ed.putString(DEF.KEY_CODE_E_DEL, "0");
				ed.putString(DEF.KEY_CODE_E_FORWARD_DEL, "0");
				ed.putString(DEF.KEY_CODE_E_SPACE, "0");
				ed.putString(DEF.KEY_CODE_E_SEARCH, "0");
				ed.putString(DEF.KEY_CODE_E_PAGE_UP, "0");
				ed.putString(DEF.KEY_CODE_E_PAGE_DOWN, "0");
				ed.putString(DEF.KEY_CODE_E_ESCAPE, "0");
				ed.putString(DEF.KEY_CODE_E_MOVEHOME, "0");
				ed.putString(DEF.KEY_CODE_E_MOVEEND, "0");
				ed.putString(DEF.KEY_CODE_E_FORWARD, "0");
				ed.putString(DEF.KEY_CODE_E_BUTTON_L1, "0");
				ed.putString(DEF.KEY_CODE_E_BUTTON_L2, "0");
				ed.putString(DEF.KEY_CODE_E_BUTTON_THUMBL, "0");
				ed.putString(DEF.KEY_CODE_E_BUTTON_R1, "0");
				ed.putString(DEF.KEY_CODE_E_BUTTON_R2, "0");
				ed.putString(DEF.KEY_CODE_E_BUTTON_THUMBR, "0");
				ed.putString(DEF.KEY_CODE_E_BUTTON_A, "0");
				ed.putString(DEF.KEY_CODE_E_BUTTON_B, "0");
				ed.putString(DEF.KEY_CODE_E_BUTTON_X, "0");
				ed.putString(DEF.KEY_CODE_E_BUTTON_Y, "0");
				ed.putString(DEF.KEY_CODE_E_BUTTON_SELECT, "0");
				ed.putString(DEF.KEY_CODE_E_BUTTON_START, "0");
				ed.putString(DEF.KEY_CODE_E_MEDIA_NEXT, "0");
				ed.putString(DEF.KEY_CODE_E_MEDIA_PREVIOUS, "0");
				ed.putString(DEF.KEY_CODE_E_MEDIA_PLAY_PAUSE, "0");
				ed.putString(DEF.KEY_CODE_E_CUSTOMKEY01, "0");
				ed.putString(DEF.KEY_CODE_E_CUSTOMKEY02, "0");
				ed.putString(DEF.KEY_CODE_E_CUSTOMKEY03, "0");
				ed.putString(DEF.KEY_CODE_E_CUSTOMKEY04, "0");
				ed.putString(DEF.KEY_CODE_E_CUSTOMKEY05, "0");
				ed.putString(DEF.KEY_CODE_E_CUSTOMKEY06, "0");
				ed.putString(DEF.KEY_CODE_E_CUSTOMKEY07, "0");
				ed.putString(DEF.KEY_CODE_E_CUSTOMKEY08, "0");
				ed.putString(DEF.KEY_CODE_E_CUSTOMKEY09, "0");
				ed.putString(DEF.KEY_CODE_E_CUSTOMKEY10, "0");
				ed.apply();
				// アクティビティを再起動
				ListViewScrollUtils.restartActivityWithPosition(SetHardwareEpubWebViewKeyActivity.this, getListView());
			}
		});
		// PreferenceScreenに追加
		...
		for (int i = 0; i < DEF.HardwareKeyTitleName.length; i++) {
			...
			// キーを設定
			listPreference.setKey(DEF.HardwareEpubKeyIdName[i]);
			// タイトルを設定
		...
		mBackKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_BACK);
		mVolumeUpKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_VOLUME_UP);
		mVolumeDownKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_VOLUME_DOWN);
		mCameraKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_CAMERA);
		mFocusKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_FOCUS);
		mMenuKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_MENU);
		mDpadLeftKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_DPAD_LEFT);
		mDpadRightKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_DPAD_RIGHT);
		mDpadUpKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_DPAD_UP);
		mDpadDownKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_DPAD_DOWN);
		...
		mPageDownKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_PAGE_DOWN);
		mEscapeKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_ESCAPE);
		mMoveHomeKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_MOVEHOME);
		mMoveEndKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_MOVEEND);
		mForwardKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_FORWARD);
		mButtonL1Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_BUTTON_L1);
		mButtonL2Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_BUTTON_L2);
		mButtonL3Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_BUTTON_THUMBL);
		mButtonR1Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_BUTTON_R1);
		mButtonR2Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_BUTTON_R2);
		mButtonR3Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_BUTTON_THUMBR);
		mButtonAKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_BUTTON_A);
		mButtonBKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_BUTTON_B);
		mButtonXKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_BUTTON_X);
		mButtonYKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_BUTTON_Y);
		mButtonSelectKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_BUTTON_SELECT);
		mButtonStartKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_BUTTON_START);
		mMediaNextKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_MEDIA_NEXT);
		mMediaPrevKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_MEDIA_PREVIOUS);
		mMediaPlayPauseKey  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_MEDIA_PLAY_PAUSE);
		mCustom01Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_CUSTOMKEY01);
		mCustom02Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_CUSTOMKEY02);
		mCustom03Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_CUSTOMKEY03);
		mCustom04Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_CUSTOMKEY04);
		mCustom05Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_CUSTOMKEY05);
		mCustom06Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_CUSTOMKEY06);
		mCustom07Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_CUSTOMKEY07);
		mCustom08Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_CUSTOMKEY08);
		mCustom09Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_CUSTOMKEY09);
		mCustom10Key  = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CODE_E_CUSTOMKEY10);
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
		if(key.equals(DEF.KEY_CODE_E_BACK)){
			mBackKey.setSummary(getBackKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_VOLUME_UP)){
			mVolumeUpKey.setSummary(getVolumeUpKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_VOLUME_DOWN)){
			mVolumeDownKey.setSummary(getVolumeDownKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_CAMERA)){
			mCameraKey.setSummary(getCameraKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_FOCUS)){
			mFocusKey.setSummary(getFocusKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_MENU)){
			mMenuKey.setSummary(getMenuKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_DPAD_LEFT)){
			mDpadLeftKey.setSummary(getDpadLeftKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_DPAD_RIGHT)){
			mDpadRightKey.setSummary(getDpadRightKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_DPAD_UP)){
			mDpadUpKey.setSummary(getDpadUpKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_DPAD_DOWN)){
			mDpadDownKey.setSummary(getDpadDownKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_DPAD_CENTER)){
			mDpadCenterKey.setSummary(getDpadCenterKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_ENTER)){
			mEnterKey.setSummary(getEnterKeySummary(sharedPreferences));
		}
		...
		else if(key.equals(DEF.KEY_CODE_E_SEARCH)){
			mSearchKey.setSummary(getSearchKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_PAGE_UP)){
			mPageUpKey.setSummary(getPageUpKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_PAGE_DOWN)){
			mPageDownKey.setSummary(getPageDownKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_ESCAPE)){
			mEscapeKey.setSummary(getEscapeKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_MOVEHOME)){
			mMoveHomeKey.setSummary(getMoveHomeKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_MOVEEND)){
			mMoveEndKey.setSummary(getMoveEndKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_FORWARD)){
			mForwardKey.setSummary(getForwardKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_BUTTON_L1)){
			mButtonL1Key.setSummary(getButtonL1KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_BUTTON_L2)){
			mButtonL2Key.setSummary(getButtonL2KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_BUTTON_THUMBL)){
			mButtonL3Key.setSummary(getButtonL3KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_BUTTON_R1)){
			mButtonR1Key.setSummary(getButtonR1KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_BUTTON_R2)){
			mButtonR2Key.setSummary(getButtonR2KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_BUTTON_THUMBR)){
			mButtonR3Key.setSummary(getButtonR3KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_BUTTON_A)){
			mButtonAKey.setSummary(getButtonAKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_BUTTON_B)){
			mButtonBKey.setSummary(getButtonBKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_BUTTON_X)){
			mButtonXKey.setSummary(getButtonXKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_BUTTON_Y)){
			mButtonYKey.setSummary(getButtonYKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_BUTTON_SELECT)){
			mButtonSelectKey.setSummary(getButtonSelectKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_BUTTON_START)){
			mButtonStartKey.setSummary(getButtonStartKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_MEDIA_NEXT)){
			mMediaNextKey.setSummary(getMediaNextKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_MEDIA_PREVIOUS)){
			mMediaPrevKey.setSummary(getMediaPrevKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_MEDIA_PLAY_PAUSE)){
			mMediaPlayPauseKey.setSummary(getMediaPlayPauseKeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_CUSTOMKEY01)){
			mCustom01Key.setSummary(getCustom01KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_CUSTOMKEY02)){
			mCustom02Key.setSummary(getCustom02KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_CUSTOMKEY03)){
			mCustom03Key.setSummary(getCustom03KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_CUSTOMKEY04)){
			mCustom04Key.setSummary(getCustom04KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_CUSTOMKEY05)){
			mCustom05Key.setSummary(getCustom05KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_CUSTOMKEY06)){
			mCustom06Key.setSummary(getCustom06KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_CUSTOMKEY07)){
			mCustom07Key.setSummary(getCustom07KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_CUSTOMKEY08)){
			mCustom08Key.setSummary(getCustom08KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_CUSTOMKEY09)){
			mCustom09Key.setSummary(getCustom09KeySummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CODE_E_CUSTOMKEY10)){
			mCustom10Key.setSummary(getCustom10KeySummary(sharedPreferences));
		}
	}

	public static int getBackKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_BACK, "0"));
	...
	public static int getVolumeUpKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_VOLUME_UP, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getVolumeDownKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_VOLUME_DOWN, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCameraKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_CAMERA, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getFocusKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_FOCUS, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getMenuKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_MENU, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getDpadLeftKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_DPAD_LEFT, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getDpadRightKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_DPAD_RIGHT, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getDpadUpKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_DPAD_UP, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getDpadDownKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_DPAD_DOWN, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getDpadCenterKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_DPAD_CENTER, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getEnterKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_ENTER, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getSpaceKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_SPACE, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getSearchKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_SEARCH, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getPageUpKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_PAGE_UP, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getPageDownKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_PAGE_DOWN, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getEscapeKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_ESCAPE, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getMoveHomeKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_MOVEHOME, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getMoveEndKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_MOVEEND, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getForwardKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_FORWARD, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonL1Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_BUTTON_L1, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonL2Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_BUTTON_L2, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonL3Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_BUTTON_THUMBL, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonR1Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_BUTTON_R1, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonR2Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_BUTTON_R2, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonR3Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_BUTTON_THUMBR, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonAKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_BUTTON_A, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonBKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_BUTTON_B, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonXKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_BUTTON_X, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonYKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_BUTTON_Y, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonSelectKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_BUTTON_SELECT, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getButtonStartKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_BUTTON_START, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getMediaNextKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_MEDIA_NEXT, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getMediaPrevKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_MEDIA_PREVIOUS, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getMediaPlayPauseKey(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_MEDIA_PLAY_PAUSE, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom01Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_CUSTOMKEY01, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom02Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_CUSTOMKEY02, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom03Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_CUSTOMKEY03, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom04Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_CUSTOMKEY04, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom05Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_CUSTOMKEY05, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom06Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_CUSTOMKEY06, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom07Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_CUSTOMKEY07, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom08Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_CUSTOMKEY08, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom09Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_CUSTOMKEY09, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCustom10Key(SharedPreferences sharedPreferences){
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CODE_E_CUSTOMKEY10, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
