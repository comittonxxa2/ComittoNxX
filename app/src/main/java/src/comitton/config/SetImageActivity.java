...
public class SetImageActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener {
	...
	public static boolean getViewNext(SharedPreferences sharedPreferences){
		boolean flag;
		flag =  DEF.getBoolean(sharedPreferences, DEF.KEY_VIEWNEXT, false);
		return flag;
	}
...
//	}
	...
	public static boolean getAnimationEnable(SharedPreferences sharedPreferences){
		boolean flag;
		flag =  DEF.getBoolean(sharedPreferences, DEF.KEY_ANIMATIONENABLE, false);
		return flag;
	}

	public static boolean getAnimationScan(SharedPreferences sharedPreferences){
		boolean flag;
		flag =  DEF.getBoolean(sharedPreferences, DEF.KEY_ANIMATIONSCAN, false);
		return flag;
	}
	...
	public static boolean getEnableContentsFile(SharedPreferences sharedPreferences){
		boolean flag;
		flag =  DEF.getBoolean(sharedPreferences, DEF.KEY_ENABLECONTENTSFILE, false);
		return flag;
	}

	public static boolean getImageSort(SharedPreferences sharedPreferences){
		boolean flag;
		flag =  DEF.getBoolean(sharedPreferences, DEF.KEY_IMAGESORT, false);
		return flag;
	}
	...
	public static boolean getMakeZoomSameAsPinch(SharedPreferences sharedPreferences){
		boolean flag;
		flag =  DEF.getBoolean(sharedPreferences, DEF.KEY_MAKEZOOMSAMEASPINCH, false);
		return flag;
	}

	public static boolean getAdjustZoomSameAsPinch(SharedPreferences sharedPreferences){
		boolean flag;
		flag =  DEF.getBoolean(sharedPreferences, DEF.KEY_ADJUSTZOOMSAMEASPINCH, false);
		return flag;
	}
