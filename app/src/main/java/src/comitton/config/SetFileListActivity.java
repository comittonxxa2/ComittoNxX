...
//	}
	...
	public static boolean getProgressBarMode(SharedPreferences sharedPreferences){
		boolean flag;
		flag =  DEF.getBoolean(sharedPreferences, DEF.KEY_PROGRESSBARMODE, false);
		return flag;
	}
	...
	public static boolean getMarkerFilterOn(SharedPreferences sharedPreferences){
		boolean flag;
		flag =  DEF.getBoolean(sharedPreferences, DEF.KEY_MARKERFILTERON, false);
		return flag;
	}

	public static boolean getMarkerDirOn(SharedPreferences sharedPreferences){
		boolean flag;
		flag =  DEF.getBoolean(sharedPreferences, DEF.KEY_MARKERDIRON, false);
		return flag;
	}
	...
	public static boolean getSetUnRarlib(SharedPreferences sharedPreferences){
		boolean flag;
		flag =  DEF.getBoolean(sharedPreferences, DEF.KEY_SETUNRARLIB, false);
		return flag;
	}

	public static boolean getAozoraZipFile(SharedPreferences sharedPreferences){
		boolean flag;
		flag =  DEF.getBoolean(sharedPreferences, DEF.KEY_AOZORAZIPFILE, false);
		return flag;
	}

	public static boolean getListExtension(SharedPreferences sharedPreferences){
		boolean flag;
		flag =  DEF.getBoolean(sharedPreferences, DEF.KEY_LISTEXTENSION, false);
		return flag;
	}
	...
	public static boolean getSkipUpdateFileList(SharedPreferences sharedPreferences){
		boolean flag;
		flag =  DEF.getBoolean(sharedPreferences, DEF.KEY_SKIPUPDATEFILELIST, false);
		return flag;
	}

	public static boolean getAozoraTextFile(SharedPreferences sharedPreferences){
		boolean flag;
		flag =  DEF.getBoolean(sharedPreferences, DEF.KEY_AOZORATEXTFILE, false);
		return flag;
	}

	public static boolean getOpenImageHtmlFile(SharedPreferences sharedPreferences){
		boolean flag;
		flag =  DEF.getBoolean(sharedPreferences, DEF.KEY_OPENIMAGEHTMLFILE, false);
		return flag;
	}
