...
import src.comitton.config.seekbar.CornerEndWidthTextLevelSeekbar;
import src.comitton.imageview.TouchPanelView;
import src.comitton.config.SetCommonActivity;

public class SetCornerEndTextViewerActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener {
	...
	private CornerEndWidthTextLevelSeekbar mCornerEndWidthLevel;
	private CornerEndHeightTextLevelSeekbar mCornerEndHeightLevel;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		addPreferencesFromResource(R.xml.cornerendtext);
		...
		if (assignactionCategory != null) {
			assignactionCategory.setOnButtonClickListener(() -> {
				...
				ed.putBoolean(DEF.KEY_CORNERENDTENABLE, false);
				ed.putInt(DEF.KEY_CORNERENDTWIDTHLEVEL, DEF.DEFAULT_CORNERENDLEVEL);
				ed.putInt(DEF.KEY_CORNERENDTHEIGHTLEVEL, DEF.DEFAULT_CORNERENDLEVEL);
				ed.apply();
				// アクティビティを再起動
		...
		buttoncategory.setOnButtonClickListener(new ButtonPreferenceCategory.OnClickListener() {
			...
			public void onButtonClick() {
				// 初期設定に戻す
				SharedPreferences.Editor ed = sharedPreferences.edit();
				ed.putString(DEF.KEY_CORNEREND_T_TAP_01, "0");
				ed.putString(DEF.KEY_CORNEREND_T_TAP_02, "0");
				ed.putString(DEF.KEY_CORNEREND_T_TAP_03, "0");
				ed.putString(DEF.KEY_CORNEREND_T_TAP_04, "0");
				ed.putString(DEF.KEY_CORNEREND_T_TAP_05, "0");
				ed.putString(DEF.KEY_CORNEREND_T_TAP_06, "0");
				ed.putString(DEF.KEY_CORNEREND_T_TAP_07, "0");
				ed.putString(DEF.KEY_CORNEREND_T_TAP_08, "0");
				ed.putString(DEF.KEY_CORNEREND_T_TAP_09, "0");
				ed.putString(DEF.KEY_CORNEREND_T_TAP_10, "0");
				ed.putString(DEF.KEY_CORNEREND_T_TAP_11, "0");
				ed.putString(DEF.KEY_CORNEREND_T_TAP_12, "0");
				ed.putString(DEF.KEY_CORNEREND_T_TAP_13, "0");
				ed.putString(DEF.KEY_CORNEREND_T_TAP_14, "0");
				ed.apply();
				// アクティビティを再起動
				ListViewScrollUtils.restartActivityWithPosition(SetCornerEndTextViewerActivity.this, getListView());
			}
		});
		// PreferenceScreenに追加
		...
		for (int i = 0; i < DEF.CornerEndTitleName.length; i++) {
			...
			// キーを設定
			listPreference.setKey(DEF.CornerEndKeyTIdName[i]);
			// タイトルを設定
		...
		mTopLeftCornerTap = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CORNEREND_T_TAP_01);
		mTopRightCornerTap = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CORNEREND_T_TAP_02);
		mBottomLeftCornerTap = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CORNEREND_T_TAP_03);
		mBottomRightCornerTap = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CORNEREND_T_TAP_04);
		mLeftEndTap = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CORNEREND_T_TAP_05);
		mRightEndTap = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CORNEREND_T_TAP_06);
		mTopEndTap = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CORNEREND_T_TAP_07);
		mBottomEndTap = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CORNEREND_T_TAP_08);
		mDoubleTap = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CORNEREND_T_TAP_09);
		mTopRightTap = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CORNEREND_T_TAP_10);
		mTopLeftTap = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CORNEREND_T_TAP_11);
		mBottomLeftTap = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CORNEREND_T_TAP_12);
		mBottomRightTap = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CORNEREND_T_TAP_13);
		mSingleTap = (ListPreference)getPreferenceScreen().findPreference(DEF.KEY_CORNEREND_T_TAP_14);
		mCornerEndWidthLevel = (CornerEndWidthTextLevelSeekbar)getPreferenceScreen().findPreference(DEF.KEY_CORNERENDTWIDTHLEVEL);
		mCornerEndHeightLevel = (CornerEndHeightTextLevelSeekbar)getPreferenceScreen().findPreference(DEF.KEY_CORNERENDTHEIGHTLEVEL);
	...
	public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
		if(key.equals(DEF.KEY_CORNEREND_T_TAP_01)){
			mTopLeftCornerTap.setSummary(getTopLeftCornerTapSummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CORNEREND_T_TAP_02)){
			mTopRightCornerTap.setSummary(getTopRightCornerTapSummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CORNEREND_T_TAP_03)){
			mBottomLeftCornerTap.setSummary(getBottomLeftCornerTapSummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CORNEREND_T_TAP_04)){
			mBottomRightCornerTap.setSummary(getBottomRightCornerTapSummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CORNEREND_T_TAP_05)){
			mLeftEndTap.setSummary(getLeftEndTapSummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CORNEREND_T_TAP_06)){
			mRightEndTap.setSummary(getRightEndTapSummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CORNEREND_T_TAP_07)){
			mTopEndTap.setSummary(getTopEndTapSummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CORNEREND_T_TAP_08)){
			mBottomEndTap.setSummary(getBottomEndTapSummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CORNEREND_T_TAP_09)){
			mDoubleTap.setSummary(getDoubleTapSummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CORNEREND_T_TAP_10)){
			mTopRightTap.setSummary(getTopRightTapSummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CORNEREND_T_TAP_11)){
			mTopLeftTap.setSummary(getTopLeftTapSummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CORNEREND_T_TAP_12)){
			mBottomLeftTap.setSummary(getBottomLeftTapSummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CORNEREND_T_TAP_13)){
			mBottomRightTap.setSummary(getBottomRightTapSummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CORNEREND_T_TAP_14)){
			mSingleTap.setSummary(getSingleTapSummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CORNERENDTWIDTHLEVEL)){
			mCornerEndWidthLevel.setSummary(getCornerEndWidthLevelSummary(sharedPreferences));
		}
		else if(key.equals(DEF.KEY_CORNERENDTHEIGHTLEVEL)){
			mCornerEndHeightLevel.setSummary(getCornerEndHeightLevelSummary(sharedPreferences));
		}
	...
	public static int getTopLeftCornerTap(SharedPreferences sharedPreferences) {
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CORNEREND_T_TAP_01, "0"));
	...
	public static int getTopRightCornerTap(SharedPreferences sharedPreferences) {
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CORNEREND_T_TAP_02, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getBottomLeftCornerTap(SharedPreferences sharedPreferences) {
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CORNEREND_T_TAP_03, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getBottomRightCornerTap(SharedPreferences sharedPreferences) {
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CORNEREND_T_TAP_04, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getLeftEndTap(SharedPreferences sharedPreferences) {
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CORNEREND_T_TAP_05, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getRightEndTap(SharedPreferences sharedPreferences) {
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CORNEREND_T_TAP_06, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getTopEndTap(SharedPreferences sharedPreferences) {
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CORNEREND_T_TAP_07, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getBottomEndTap(SharedPreferences sharedPreferences) {
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CORNEREND_T_TAP_08, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getDoubleTap(SharedPreferences sharedPreferences) {
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CORNEREND_T_TAP_09, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getTopRightTap(SharedPreferences sharedPreferences) {
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CORNEREND_T_TAP_10, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getTopLeftTap(SharedPreferences sharedPreferences) {
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CORNEREND_T_TAP_11, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getBottomLeftTap(SharedPreferences sharedPreferences) {
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CORNEREND_T_TAP_12, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getBottomRightTap(SharedPreferences sharedPreferences) {
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CORNEREND_T_TAP_13, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getSingleTap(SharedPreferences sharedPreferences) {
		int val = convertdata(DEF.getInt(sharedPreferences, DEF.KEY_CORNEREND_T_TAP_14, "0"));
		if (val < 0 || val >= mTpView.HardwareKeyName.length){
			val = 0;
		}
		return val;
	...
	public static int getCornerEndWidthLevel(SharedPreferences sharedPreferences){
		int num;
		num = DEF.getInt(sharedPreferences, DEF.KEY_CORNERENDTWIDTHLEVEL, DEF.DEFAULT_CORNERENDLEVEL);
		return num;
	}
	public static int getCornerEndHeightLevel(SharedPreferences sharedPreferences){
		int num;
		num = DEF.getInt(sharedPreferences, DEF.KEY_CORNERENDTHEIGHTLEVEL, DEF.DEFAULT_CORNERENDLEVEL);
		return num;
	}
	public static boolean getCornerEndEnable(SharedPreferences sharedPreferences){
		boolean num;
		num = DEF.getBoolean(sharedPreferences, DEF.KEY_CORNERENDTENABLE, false);
		return num;
	}
